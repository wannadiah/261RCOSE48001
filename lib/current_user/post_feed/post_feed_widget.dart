...
class PostFeedWidget extends StatefulWidget {
  ...
  static String routeName = 'PostFeed';
  static String routePath = '/postFeed';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: FutureBuilder<List<PostRow>>(
          ...
          builder: (context, snapshot) {
            ...
            List<PostRow> listViewPostRowList = snapshot.data!;

            return ListView.builder(
              padding: EdgeInsets.zero,
              shrinkWrap: true,
              scrollDirection: Axis.vertical,
              itemCount: listViewPostRowList.length,
              itemBuilder: (context, listViewIndex) {
                final listViewPostRow = listViewPostRowList[listViewIndex];
                return Container(
                  width: 100.0,
                  height: 852.14,
