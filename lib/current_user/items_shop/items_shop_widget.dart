...
import 'items_shop_model.dart';
export 'items_shop_model.dart';

/// display character user can customize and it changes based on percentage of
/// steps achieved
class ItemsShopWidget extends StatefulWidget {
  const ItemsShopWidget({super.key});

  static String routeName = 'ItemsShop';
  static String routePath = '/itemsShop';

  @override
  State<ItemsShopWidget> createState() => _ItemsShopWidgetState();
}

class _ItemsShopWidgetState extends State<ItemsShopWidget> {
  late ItemsShopModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemsShopModel());
  }
